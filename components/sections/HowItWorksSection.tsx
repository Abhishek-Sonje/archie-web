...
function IsometricTerminal() {
  return (
    <div className="relative w-24 h-24 transform-3d transition-transform duration-700 ease-out group-hover:transform-[rotateX(60deg)_rotateZ(-35deg)_scale(1.1)] transform-[rotateX(60deg)_rotateZ(-45deg)]">
  ...
  return (
    <div className="relative w-24 h-24 transform-3d transition-transform duration-700 ease-out group-hover:transform-[rotateX(60deg)_rotateZ(-35deg)_scale(1.1)] transform-[rotateX(60deg)_rotateZ(-45deg)]">
      ...
      <div className="absolute inset-1.5 bg-bg border border-border rounded flex flex-col items-center justify-center gap-2 p-2 transition-transform duration-700 ease-out transform-[translateZ(8px)] group-hover:transform-[translateZ(24px)]">
        <svg
          viewBox="0 0 96 96"
          className="w-7 h-7 text-ink opacity-90 drop-shadow-[0_2px_4px_rgba(0,0,0,0.4)]"
          fill="currentColor"
        ...
        <div className="flex items-center gap-1 bg-surface border border-border rounded px-1.5 py-0.5 w-full">
          ...
          <div className="w-1 h-1.5 bg-diff-add-fg rounded-sm terminal-cursor" />
        </div>
      </div>
    </div>
  );
...
export default function HowItWorksSection() {
  return (
    ...
    >
      <div className="max-w-200 mx-auto text-center mb-16 lg:mb-24">
        <h2
      ...
      <div className="relative max-w-6xl mx-auto">
        <motion.div
          ...
          className="absolute top-32 left-0 w-full h-0.5 hidden lg:block z-0 pointer-events-none"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 1, delay: 0.1, ease: "easeInOut" }}
          className="absolute top-0 left-12 w-0.5 h-full block lg:hidden z-0 pointer-events-none"
        >
          <svg width="100%" height="100%" preserveAspectRatio="none">
            <line
              x1="1"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10 relative z-10">
          {HOW_IT_WORKS_STEPS.map((step, index) => (
            ...
            >
              <div className="relative w-full h-64 flex items-center justify-center bg-surface-2/30 border-b border-border/50 perspective-[1000px] overflow-hidden">
